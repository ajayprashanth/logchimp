...
<p align="center">
  Track your customers' feedback and build better products with LogChimp
</p>
...
Read our [deployment docs](https://logchimp.codecarrot.net/docs/install) to get started:

- Self-hosting on Ubuntu  
- One-click deploy on the cloud

---

## Let's Talk

<a href="https://cal.com/yashu/logchimp?utm_source=banner&utm_campaign=oss">
  <img alt="Book a session with Cal.com" src="https://cal.com/book-with-cal-dark.svg" />
</a>
...
Stay up to date with LogChimp development:
...
We welcome contributions! To avoid conflicts with ongoing work:

1. Read our [contributing guide](CONTRIBUTING.md)  
2. **Discuss your ideas publicly (GitHub/Discord) BEFORE starting development**  
3. Get approval from a core team member  

This ensures aligned efforts and prevents duplicated or conflicting work.
